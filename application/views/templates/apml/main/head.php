<meta charset="UTF-8">
        ...
        <link href="<?= URL_RESOURCES ?>templates/apml/css/skins/skin-blue-toastr.css" rel="stylesheet" type="text/css" />
        <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>
        <script src="<?= URL_RESOURCES ?>config/apml/toastr-options.js"></script>
        ...
        <!-- Tema AdminPML -->
        <link href="<?= URL_RESOURCES ?>templates/apml/css/admin-pml.css" rel="stylesheet" type="text/css" />
        <link href="<?= URL_RESOURCES ?>templates/apml/css/mobile.css" rel="stylesheet" type="text/css" />
        <link href="<?= URL_RESOURCES ?>templates/apml/css/skins/skin-grafinar.css" rel="stylesheet" type="text/css" />
        <script src="<?= URL_RESOURCES ?>templates/apml/js/app.js"></script>
        <script src="<?= URL_RESOURCES ?>templates/apml/js/routing.js"></script>
        ...
        <?php if ( $this->session->userdata('logged') ) : ?>
            <!-- Elementos del menú -->
            <script src="<?= URL_RESOURCES ?>config/apml/menus/nav_1_elements_<?= $this->session->userdata('role') ?>.js"></script>
